...
\input{Propuesta/justificacion.tex}

\chapter{Objetivos}\label{Objetivos}
\input{Propuesta/objetivos.tex}

\chapter{Temática a desarrollar}\label{tematicaADesarrollar}
\input{Propuesta/tematicaADesarrollar.tex}
...
\input{Trabajo/introduccion.tex}

\chapter{Marco conceptual}\index{Marco conceptual}\label{marcoConceptual}
\input{Trabajo/MarcoConceputal/principal.tex}

\chapter{Recursos Educativos}
\input{Trabajo/RecursosEducativos/principal.tex}
...
\input{Trabajo/Anexo01/oracleVirtualBox.tex}
