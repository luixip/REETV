...
\begin{figure}[!hbtp]
	\centering
	\includegraphics[width=\linewidth]{RE05_Docker/REDocker_versiones.png}
	\vspace{-0.2cm}
...
\input{RE05_Docker/REDocker_Instalacion.tex}
...
\input{RE05_Docker/REDocker_CasoResuelto.tex}